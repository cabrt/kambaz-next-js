...
tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>Cream together butter, brown sugar, and white sugar until fluffy.</li>
          <li>Beat in eggs and vanilla extract.</li>
          <li>Mix in flour, baking soda, and salt until just combined.</li>
          <li>Fold in chocolate chips.</li>
          <li>Drop rounded tablespoons of dough onto prepared baking sheets.</li>
          <li>Bake for 9-11 minutes until golden brown around edges.</li>
