      ...
      <Table striped>
        ...
        <tbody>
          ...
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Jerome</span>{" "}
              <span className="wd-last-name">Saint</span>
            </td>
          ...
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Leon</span>{" "}
              <span className="wd-last-name">Williams</span>
            </td>
          ...
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Teddy</span>{" "}
              <span className="wd-last-name">Macdonald</span>
            </td>
            <td className="wd-login-id">001234564S</td>
            <td className="wd-section">S102</td>
            <td className="wd-role">TA</td>
            <td className="wd-last-activity">2020-10-03</td>
            <td className="wd-total-activity">15:30:45</td>
          </tr>
        </tbody>
      </Table>
    </div>
